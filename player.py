...
class Player(AnimateSprite) :
    ...
    def __init__(self, x, y) :
        ...
        self.images = {
                        'down': self.get_images(self.animation.PERSO[0]),
                        'left': self.get_images(self.animation.PERSO[1]),
                        'right': self.get_images(self.animation.PERSO[2]),
                        'up': self.get_images(self.animation.PERSO[3]),
                        }
