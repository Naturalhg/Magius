...
class Worlds() :
    ...
    def switch_world(self) :
        ...
        tmx_data_tree_h = pytmx.util_pygame.load_pygame('tree_house.tmx')
        tmx_data_inside_h = pytmx.util_pygame.load_pygame('inside_house.tmx')
        tmx_data_market1 = pytmx.util_pygame.load_pygame('market1.tmx')
        tmx_data_market2 = pytmx.util_pygame.load_pygame('market2.tmx')
        tmx_data_town_hall = pytmx.util_pygame.load_pygame('town_hall.tmx')
